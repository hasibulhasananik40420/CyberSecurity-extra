        ...
        <div className=''>
            ...
            <div className='grid grid-cols-1 justify-items-center gap-x-1 gap-y-12 md:grid-cols-2 md:gap-x-2 md:gap-y-12 md:max-w-containerxs md:mx-auto lg:grid-cols-4 lg:gap-x-4 lg:gap-y-8 lg:max-w-contentContainer lg:mx-auto xl:grid-cols-4 xl:gap-x-2 xl:gap-y-16 xl:max-w-container xl:mx-auto'>
                ...
                <div className='w-[270px]'>
                    <img className='hover:mix-blend-luminosity object-cover hover:scale-105 duration-500' src={blogimage9} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity  hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage1} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage3} alt="" />
                    <h1 className='text-white font-Cuprum font-semibold text-2xl mt-4'>Cybersecurity Attacks & the Transportation Industry</h1>
                    <p className='text-sm font-medium text-textYellow mt-3 font-Inter'>March 17, 2022</p>
                </div>
                {/************** blog card 3 end now ***************/}
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage4} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage5} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage6} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage7} alt="" />
                    <h1 className='text-white font-Cuprum font-semibold text-2xl mt-4'>Cybersecurity Attacks & the Transportation Industry</h1>
                    <p className='text-sm font-medium text-textYellow mt-3 font-Inter'>March 17, 2022</p>
                </div>
                {/************** blog card 7 end now ***************/}
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage8} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage10} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage11} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage12} alt="" />
                ...
                <div className='w-[270px]'>
                    <img className='mix-blend-luminosity hover:mix-blend-normal object-cover hover:scale-105 duration-500' src={blogimage2} alt="" />
